...
root.grid_rowconfigure((1, 2, 3, 4, 5, 6, 7), weight=1)

# Placing the frames in the grid
drop_down_frame = ttk.Frame(root, width=400, height=200, relief="solid")
drop_down_frame.grid(column=0, row=0, padx=10, pady=10, sticky="nsew")

label_frame = ttk.Frame(root, width=400, height=200, relief="solid")
label_frame.grid(column=0, row=1, rowspan=7, padx=10, pady=10, sticky="nsew")

# Initializing the Variables
stringvar = tk.StringVar()
stringvar.set('Drop image here!')
...
drop_down_label = ttk.Label(drop_down_frame, text="Select target file type:")
...
label = ttk.Label(label_frame, ondrop=drop, textvariable=stringvar,
                padding=(30, 20), relief="solid")
...
label.bind("<<DropEnter>>", show_item)
